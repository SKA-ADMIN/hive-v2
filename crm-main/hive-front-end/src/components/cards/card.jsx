...
const Card = (props) => {
  ...
  return (
      ...
      <div
        className={` cursor-pointer transition delay-100 w-3/12  p-2 py-4 shadow-xl  border rounded-xl bg-gradient-to-r ${
          Color[props.icon]
        }`}
      >
        ...
        <p className="text-gray-200 text-m  ">{props.title}</p>
        <p className="text-gray-50 text-xl  font-semibold  ">{props.balance}</p>
